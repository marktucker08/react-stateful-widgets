...
export default function Programmers() {
  ...
  const [awesomeId, setId] = useState(null);
  const [programmer, setProg] = useState(null);
  ...
  const style = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: listOfAwesome.name != null ? 'gold' : 'royalblue', // 🤔 color turns to gold, when celebrating
  };
